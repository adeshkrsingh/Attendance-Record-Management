...
echo "<form method='post' action='firsttimesendotp.php'>";

echo "<div class='form-group col-lg-12'>";
echo "<input type='email' id='email id' placeholder='Enter Your Email ID' class='form-control col-lg-12' name='email' />";
echo "</div>";

echo "<div class='form-group col-lg-12'>";
echo "<input type='submit' id='submit' class='form-control col-lg-12' name='submit' value='SEND OTP' />";
echo "</div>";
