    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">BUNDELKHAND INSTITUTE OF ENGINEERING AND TECHNOLOGY</a>
            </div>
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="student_profile.php"><i class="material-icons">person</i>Profile</a></li>
