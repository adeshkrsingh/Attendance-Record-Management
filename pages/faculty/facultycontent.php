                 ...
                 if ($row['LId']==$UserIdLoaded)
                       {
                        ...
                        $Contact = $row['Contact'];
                        $imgpresence = $row['img'];
                        if(!empty($imgpresence)) { $img = "/profile/faculty/".$Email."/".$imgpresence ; }
                        else { $img = ""; }
...
<div class="container" style="margin-left: 0px;margin-right: 0px;">
        <div id="sidebar" style="">
          <ul>
            ...
            <li><a href='f_attendence.php'>View Attendence</a></li>
            <li><a href='report.php'>Generate Report</a></li>
            <li><a href='f_updateProfile.php'>Profile</a></li>
            <li><a href='f_posttute.php'>Assignment</a></li>
            <li><a href='f_viewgiventute.php'>Given Assignment</a></li>
          ...
          <div style="padding-top: 10px; float: left;"> <img src="/defaultimg/header-biet-logo.png"  ></div>
            ...
            <div class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="menu1" style="right: 0px; left: auto; margin-top: 6px; color: #5A738E; border-radius: 0px; background-color:#1b262f; ">
                        <li>
                            <a href="f_updateProfile.php"><i class="fa fa-fw fa-user"></i> Profile</a>
                        </li>
                        <li>
